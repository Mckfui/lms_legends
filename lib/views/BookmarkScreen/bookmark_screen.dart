...
import 'package:lsm_legends/controllers/bookmark_controller.dart';
import 'package:lsm_legends/global_widgets/custom_app_bar.dart';
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return bookmarks.isEmpty
            ? const Center(child: Text("You don't have any bookmark lesson"))
            : ListView.builder(
